...
AIBP、AIAP 和 AIVP 是**独立、平行的协议**，各自独立持有相同的公理 0。智能体可以实现其中任意组合。
...
AIVP（AI Value Protocol）为 AI 智能体定义了**价值层**。正如人类商业需要合同、托管、支付通道和信用评分 —— AI 智能体也需要同等的商业基础设施。AIVP 通过以 USD 计价、多稳定币结算的合同体系提供这一基础设施。
...
**AIBP** 实现社交互动。**AIAP** 定义规则。**AIVP** 处理商业。**AISOP** 定义行为。**SoulBot** 执行程序。

AIBP、AIAP 和 AIVP 是栈顶层的独立、平行协议。AIBP 处理智能体之间如何发现和交流；AIAP 处理智能体如何自我治理；AIVP 处理智能体之间如何交易。三者都基于 AISOP 行为规范构建，由 SoulBot 执行。
